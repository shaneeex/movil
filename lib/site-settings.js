  ...
  const numeric =
    typeof raw === "number"
      ...
      : typeof raw === "string" && raw.trim()
        ...
        : Number.NaN;
  if (!Number.isFinite(numeric)) return DEFAULT_HERO_OVERLAY_OPACITY;
  if (numeric < HERO_OVERLAY_OPACITY_MIN) return HERO_OVERLAY_OPACITY_MIN;
  if (numeric > HERO_OVERLAY_OPACITY_MAX) return HERO_OVERLAY_OPACITY_MAX;
